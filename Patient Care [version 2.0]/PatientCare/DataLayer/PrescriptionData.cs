...
namespace DataLayer
{
    public class PrescriptionData
    {
        ...
        {
            string query = "SELECT MedicineForPrescription.presID, MedicineForPrescription.MedGenericName, MedicineForPrescription.Intake,"
        ...
        {
            string query = "SELECT TestForPrescription.presID, TestForPrescription.testName, TestForPrescription.testComment"
                            + " FROM prescription"
        ...
        public bool deletePrescribedMedicine(string medName, string presID)
        {
            string deleteCommand = "DELETE FROM MedicineForPrescription WHERE MedGenericName = '"
                + medName + "' AND presID = '" + presID + "';";
        ...
        public bool deletePrescribedTest(string testName, string presID)
        {
            string deleteCommand = "DELETE FROM TestForPrescription WHERE testName = '"
                + testName + "' AND presID = '" + presID + "';";
